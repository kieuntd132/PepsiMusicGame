...
import { BACK, CENTER_BUTTON, ICON_LYRIC, BAR_TIME, ICON_RECORD_BACK, ICON_CHECK } from '../../../../../assets'
    ...
    return (
        <Background>
            ...
            <View style={styles.group1}>
                <TouchableOpacity style={{marginLeft: Dimensions.get('window').width * 0.15,}}>
                    <Image source={ICON_RECORD_BACK} style={styles.RB} />
                </TouchableOpacity>
                <TouchableOpacity style={{marginRight: Dimensions.get('window').width * 0.1,}}>
                    <Image source={CENTER_BUTTON} style={styles.center} />
                </TouchableOpacity>
                <TouchableOpacity>
                    <Image source={ICON_CHECK} style={styles.Check} />
                </TouchableOpacity>
            </View>
        </Background>
    )
